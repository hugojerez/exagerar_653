Blank Software and Apache Cordova Project
==========================================
...
They are included for use by the Software template/demo panel and have no use
...
Use this project as a starting point for an Software or Apache Cordova hybrid
...
* within the the Software Simulate tab (and old Emulate tab)

* in the Software App Preview application (Test tab)
